package slipstream.paxos.fragmentation;
...
public class FragmentingGroup {
  ...
  public FragmentingGroup(GroupMembership membership, Receiver receiver) throws SocketException, UnknownHostException {
