...
public class KeystoreManagerCtrl
{
    ...
    private SecurityConf.KEYSTORE_TYPE keyType            = null;
    ...
    private void setupCommandLine()
    {
        ...
        Option keyType = OptionBuilder.withLongOpt(KEY_TYPE)
                ...
                .withDescription(MessageFormat.format("Type of key: {0}",
                        SecurityConf.KEYSTORE_TYPE.getListValues("|")))
                .create(_KEY_TYPE);
    ...
    public static void main(String argv[]) throws Exception
    {
        ...
        try
        {
            ...
            if (line.hasOption(_KEY_TYPE))
            {
                ...
                SecurityConf.KEYSTORE_TYPE certificateTYpe = SecurityConf.KEYSTORE_TYPE
                        .fromString(keyType);
