...
package slipstream.replicator.extractor.oracle.redo;
...
import slipstream.replicator.commons.common.cache.LargeObjectArray;
import slipstream.replicator.commons.common.cache.LargeObjectScanner;
import slipstream.replicator.commons.common.cache.RawByteCache;
...
class PlogTransaction implements Comparable<PlogTransaction>
{
            ...
            SerialException, SQLException
    {
        ...
        ArrayList<OneRowChange.ColumnSpec> keySpec = oneRowChange.getKeySpec();
        ArrayList<OneRowChange.ColumnSpec> valSpec = oneRowChange.getColumnSpec();

        ArrayList<ArrayList<OneRowChange.ColumnVal>> keyValuesArray = oneRowChange
                .getKeyValues();
        ArrayList<OneRowChange.ColumnVal> keyValues = new ArrayList<OneRowChange.ColumnVal>();
        ...
        ArrayList<ArrayList<OneRowChange.ColumnVal>> valValuesArray = oneRowChange
                .getColumnValues();
        ArrayList<OneRowChange.ColumnVal> valValues = new ArrayList<OneRowChange.ColumnVal>();
