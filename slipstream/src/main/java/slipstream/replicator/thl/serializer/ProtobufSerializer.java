...
package slipstream.replicator.thl.serializer;
...
import slipstream.replicator.database.AdditionalTypes;
import slipstream.replicator.dbms.DBMSData;
import slipstream.replicator.dbms.LoadDataFileFragment;
import slipstream.replicator.dbms.LoadDataFileQuery;
import slipstream.replicator.dbms.OneRowChange;
import slipstream.replicator.dbms.RowChangeData;
import slipstream.replicator.dbms.RowIdData;
...
import slipstream.replicator.event.ReplDBMSFilteredEvent;
...
import slipstream.replicator.thl.THLEvent;
import slipstream.replicator.thl.protobuf.TungstenProtos.Header;
import slipstream.replicator.thl.protobuf.TungstenProtos.ProtobufEventOption;
import slipstream.replicator.thl.protobuf.TungstenProtos.ProtobufLoadDataFileFragment;
import slipstream.replicator.thl.protobuf.TungstenProtos.ProtobufLoadDataFileQuery;
import slipstream.replicator.thl.protobuf.TungstenProtos.ProtobufOneChange;
import slipstream.replicator.thl.protobuf.TungstenProtos.ProtobufOneChange.Builder;
import slipstream.replicator.thl.protobuf.TungstenProtos.ProtobufOneRowChange;
import slipstream.replicator.thl.protobuf.TungstenProtos.ProtobufOneRowChange.ActionType;
import slipstream.replicator.thl.protobuf.TungstenProtos.ProtobufOneRowChange.ProtobufColumnSpec;
import slipstream.replicator.thl.protobuf.TungstenProtos.ProtobufOneRowChange.ProtobufRowValue;
import slipstream.replicator.thl.protobuf.TungstenProtos.ProtobufOneRowChange.ProtobufRowValue.ProtobufColumnVal;
import slipstream.replicator.thl.protobuf.TungstenProtos.ProtobufOneRowChange.ProtobufRowValue.ProtobufColumnVal.Type;
import slipstream.replicator.thl.protobuf.TungstenProtos.ProtobufReplDBMSEvent;
import slipstream.replicator.thl.protobuf.TungstenProtos.ProtobufRowChangeData;
import slipstream.replicator.thl.protobuf.TungstenProtos.ProtobufRowIdData;
import slipstream.replicator.thl.protobuf.TungstenProtos.ProtobufStatementData;
...
public class ProtobufSerializer implements Serializer
{
            ...
            RowChangeData rowEv)
    {
        ...
        try
        {
            for (OneRowChange oneRowChange : rowChanges)
            {
                ...
                ArrayList<OneRowChange.ColumnSpec> list = oneRowChange.getColumnSpec();
                for (OneRowChange.ColumnSpec columnSpec : list)
                {
                ...
                ArrayList<ArrayList<OneRowChange.ColumnVal>> rowValues = oneRowChange
                        .getColumnValues();

                if (logger.isDebugEnabled())
                    trace.append("\n    Columns values :\n");

                for (ArrayList<OneRowChange.ColumnVal> row : rowValues)
                {
                    ...
                    for (int i = 0; i < row.size(); i++)
                    {
                        ...
                        OneRowChange.ColumnVal colValue = row.get(i);
                        OneRowChange.ColumnSpec colSpec = oneRowChange.getColumnSpec()
                                .get(i);
                ...
                for (ArrayList<OneRowChange.ColumnVal> row : rowValues)
                {
                    ...
                    for (int i = 0; i < row.size(); i++)
                    {
                        ...
                        OneRowChange.ColumnVal colValue = row.get(i);
                        OneRowChange.ColumnSpec colSpec = oneRowChange.getKeySpec().get(i);
                        serializeRowValue(valueBuilder, colValue, colSpec);
                        rowBuilder.addColumnValue(valueBuilder);
                    }
                    if (logger.isDebugEnabled())
    ...
    private void serializeRowValue(ProtobufColumnVal.Builder valueBuilder,
                                   OneRowChange.ColumnVal colValue, OneRowChange.ColumnSpec colSpec)
    {
        if (logger.isDebugEnabled())
        {
            trace.append("Type = ");
    ...
    private RowChangeData deserializeRows(ProtobufRowChangeData rows)
    {
        ...
        for (ProtobufOneRowChange oneRowChange : rowChangeList)
        {
            ...
            {
                OneRowChange.ColumnSpec c = rowChange.new ColumnSpec();
            ...
            ArrayList<OneRowChange.ColumnVal> colValues = null;

            for (ProtobufRowValue rowValue : oneRowChange.getColumnValuesList())
            {
                colValues = new ArrayList<OneRowChange.ColumnVal>();
                for (ProtobufColumnVal columnVal : rowValue
                        .getColumnValueList())
                {
                    OneRowChange.ColumnVal v = rowChange.new ColumnVal();
     ...
     * @param columnSpec
     */
    private void traceColumnSpec(OneRowChange.ColumnSpec columnSpec)
    {
        if (logger.isDebugEnabled())
        {
            trace.append("          - ");
