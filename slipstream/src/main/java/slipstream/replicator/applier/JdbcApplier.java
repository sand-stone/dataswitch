...
package slipstream.replicator.applier;
...
import slipstream.replicator.thl.THLManagerCtrl;
...
public class JdbcApplier implements RawApplier
{
    ...
    protected void setObject(PreparedStatement prepStatement, int bindLoc,
                             OneRowChange.ColumnVal value, OneRowChange.ColumnSpec columnSpec, String sourceDbmsType)
                    throws SQLException
    {
