...
import slipstream.replicator.dbms.OneRowChange.ColumnSpec;
import slipstream.replicator.dbms.OneRowChange.ColumnVal;
...
public class OracleApplier extends JdbcApplier
{
    ...
    public void configure(PluginContext context) throws ReplicatorException
    {
        ...
        hasPlogs = property.length() > 0 && property.equals("PlogExtractor");
