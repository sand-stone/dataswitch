...
package slipstream.replicator.datatypes;
...
public class Numeric
{
    ...
    OneRowChange.ColumnSpec columnSpec   = null;

    public Numeric(OneRowChange.ColumnSpec columnSpec, OneRowChange.ColumnVal value)
    {
     ...
     */
    public OneRowChange.ColumnSpec getColumnSpec()
    {
        return columnSpec;
    }
