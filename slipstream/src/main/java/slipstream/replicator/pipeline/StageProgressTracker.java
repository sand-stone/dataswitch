...
package slipstream.replicator.pipeline;
...
import slipstream.replicator.storage.ParallelStore;
import slipstream.replicator.util.AtomicIntervalGuard;
import slipstream.replicator.util.EventIdWatchPredicate;
import slipstream.replicator.util.HeartbeatWatchPredicate;
import slipstream.replicator.util.SeqnoWatchPredicate;
import slipstream.replicator.util.SourceTimestampWatchPredicate;
import slipstream.replicator.util.Watch;
import slipstream.replicator.util.WatchAction;
import slipstream.replicator.util.WatchManager;
import slipstream.replicator.util.WatchPredicate;
