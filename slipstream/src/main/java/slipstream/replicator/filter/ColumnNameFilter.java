...
public class ColumnNameFilter implements Filter
{
            ...
            throws ReplicatorException
    {
        ...
        int index = 0;
        for (Iterator<OneRowChange.ColumnSpec> iterator = orc.getColumnSpec().iterator(); iterator
                .hasNext();)
        {
            OneRowChange.ColumnSpec type = iterator.next();
        ...
        index = 0;
        for (Iterator<OneRowChange.ColumnSpec> iterator = orc.getKeySpec().iterator(); iterator
                .hasNext();)
        {
            OneRowChange.ColumnSpec type = iterator.next();
            type.setName(columns.get(index).getName());
