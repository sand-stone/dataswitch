...
package slipstream.replicator.ddlscan;
...
import slipstream.replicator.database.MySQLDatabase;
import slipstream.replicator.database.OracleDatabase;
import slipstream.replicator.database.Table;
import slipstream.replicator.filter.EnumToStringFilter;
import slipstream.replicator.filter.RenameDefinitions;
