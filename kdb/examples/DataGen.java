...
public class DataGen {
  private static Logger log = LogManager.getLogger(DataGen.class);
  ...
  public static long getLSN(Client client) {
    try {
  ...
  public static void main(String[] args) {
    ...
    while(true) {
      ...
      for(int i = 0; i < range; i++) {
        log.info("master xevents{} LSN {}", i, getLSN(mclients[i]));
        log.info("slave1 xevents{} LSN {}", i, getLSN(s1clients[i]));
        log.info("slave2 xevents{} LSN {}", i, getLSN(s2clients[i]));
      }
    }
  }
